...
Catch {
    ...
    $null = Import-PSSession $Session -CommandName Get-UnifiedGroup, Get-OrganizationConfig, Get-MailboxFolderStatistics, Search-UnifiedAuditLog, Get-Mailbox
...
$Report = @()
$ReportFile = "c:\repos\espc18\ListOfObsoleteGroups.html"
$htmlhead = "<html>
	   <style>
