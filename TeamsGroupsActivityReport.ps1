# Original: https://gallery.technet.microsoft.com/Check-for-obsolete-Office-c0020a42
...
$Report = @()
$ReportFile = ".\TeamsGroupsActivityReport.html"
$CSVFile = ".\TeamsGroupsActivityReport.csv"
$htmlhead="<html>
	   <style>
